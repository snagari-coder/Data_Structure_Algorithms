...
# Finding the kth largest element in an array/heap
...
class MaxHeap:
    ...
    def print(self):
        for i in range(1, (self.size // 2) + 1):
            print("Parent: " + str(self.Heap[i]) + " Left Child:" + str(self.Heap[2 * i]) + " Right Child:" + str(
                self.Heap[2 * i + 1]))
...
print("The 3rd largest element in the array is: " + str(myMinHeap.kth_maximum(3)))
